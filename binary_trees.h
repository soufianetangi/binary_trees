...
void binary_tree_preorder(const binary_tree_t *tree, void (*funcs)(int));
void binary_tree_inorder(const binary_tree_t *tree, void (*funcs)(int));
...
size_t binary_tree_nodes(const binary_tree_t *trees);
int binary_tree_balance(const binary_tree_t *trees);
int binary_tree_is_full(const binary_tree_t *trees);
int binary_tree_is_perfect(const binary_tree_t *trees);
